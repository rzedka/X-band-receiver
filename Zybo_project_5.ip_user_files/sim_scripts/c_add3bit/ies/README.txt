...
#
# Generated by export_simulation on Sat Apr 27 12:27:16 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './c_add3bit.sh' script.

./c_add3bit.sh -reset_run
...
./c_add3bit.sh -noclean_files

For more information on the script, please type './c_add3bit.sh -help'.

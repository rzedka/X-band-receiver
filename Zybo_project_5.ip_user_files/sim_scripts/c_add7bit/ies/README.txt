...
#
# Generated by export_simulation on Sat Apr 27 12:29:26 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './c_add7bit.sh' script.

./c_add7bit.sh -reset_run
...
./c_add7bit.sh -noclean_files

For more information on the script, please type './c_add7bit.sh -help'.

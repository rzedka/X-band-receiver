...
#
# Generated by export_simulation on Sat Apr 27 12:28:04 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './c_add4bit.sh' script.

./c_add4bit.sh -reset_run
...
./c_add4bit.sh -noclean_files

For more information on the script, please type './c_add4bit.sh -help'.
